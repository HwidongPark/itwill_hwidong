...
public class LambdaMain02 {
    ...
    public static void main(String[] args) {
        ...
        // numbers 원소들 중에서 짝수들로만 이루어진 리스트를 만들고 출력.
        ...
        List<Object> result2 = app.filter(result, x -> ((String) x).length() >= 5);
...
//                }
        ...
        List<Object> evenOrOdd2 = app.map(numbers, (x) -> ((Integer) x % 2 == 0 ? "even" : "odd"));
        ...
        List<Object> upperCases = app.map(languages, (s) -> ((String) s).toUpperCase());
