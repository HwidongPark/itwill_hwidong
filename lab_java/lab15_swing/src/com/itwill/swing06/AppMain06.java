...
//                JOptionPane.showMessageDialog(frame, "안녕하세요");
                JOptionPane.showMessageDialog(
                        ...
                        "Hello, Swing",  // 다이얼로그에 표시될 메세지 
                        "메시지",   // 다이얼로그의 타이틀 
                        JOptionPane.ERROR_MESSAGE);
            }
        });
        btnMsgDlg.setFont(new Font("D2Coding", Font.PLAIN, 20));
        btnMsgDlg.setBounds(12, 10, 460, 72);
...
//                int result = JOptionPane.showConfirmDialog(frame, "식사 하셨나요?");
        ...
        btnConfirmDlg.setBounds(12, 111, 460, 72);
        ...
        btnInputDlg.setBounds(12, 209, 460, 72);
        ...
        btnCustomDlg.setBounds(12, 300, 460, 72);
        ...
        btnCustomFrame.setFont(new Font("D2Coding", Font.PLAIN, 20));
        btnCustomFrame.setBounds(12, 394, 460, 72);
