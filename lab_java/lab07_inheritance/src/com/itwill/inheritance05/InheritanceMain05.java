...
public class InheritanceMain05 {
    ...
    public static void main(String[] args) {
        ...
        int hash = t.hashCode();        // 해시코드를 리턴하는 메서드
        System.out.println(hash + " = " + Integer.toHexString(hash));
        System.out.println(t.toString());       // 문자열 타입..
        System.out.println(t);      // T 타입
        // -> System.out.println(Object o) 메서드는 객체의 문자열 표현식을 콘솔에 출력한다.
        // -> println() 메서드는 객체가 가지고 있는 toString()의 리턴값을 출력.. 그래서 사실 위의 코드 2줄은 서로 같다.
        ...
        // -> Scanner class는 toString 메서드를 재정의(override)하고 있음
        
        
        
        T t2 = new T();
        System.out.println(t.equals(t2));       // 두 객체가 같은지를 리턴.
        
        T t3 = t;
        System.out.println(t.equals(t3));
        
        // equals method가 재정의(override)된 예
        String s1 = new String("java");  // 이렇게도 쓸 수 있음. 근데 이렇게 사용하지 않는게 좋음
        ...
        // -> 두 문자열이 같은 지를 비교할 때는 반드시 equals method를 사용해야 함.
