 ...
 * Reader
 * |__ InputStreamReader, BufferedStreamReader
 *     |__ FileReader --> 얘는 InputStreamReader를 상속 받아서 만들어진 클래스. BufferedStreamReader에게는 상속받지 않음.
 * Writer
...
public class FileMain08 {
    ...
    public static void main(String[] args) {
        ...
        // FileReader와 FileWriter 클래스는 인코딩 설정 방법이 없음.
        try(
        ...
        // Java 11 버전부터 FileReader, FileWriter 객체에서 인코딩 방식을 설정할 수 있게됨
        try(
                //1. FileReader 객체를 생성할 때 인코딩 방식을 결정.
