...
public class PolyglotMain {
    ...
    //Fields
    String IMAGEPATH = "images\\logo_final.png";
    ...
    private void initialize() {
        ...
        passwordField.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				...
				if (password.length() >= 30) {	// 30글자 넘어갈 경우
					JOptionPane.showMessageDialog(frame, "30글자 초과로 작성 불가", "작성 불가", JOptionPane.INFORMATION_MESSAGE);
					if (c == '\b') {
