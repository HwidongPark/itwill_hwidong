...
public class LearningSquareFrame extends JFrame {
    ...
    public void initialize(Component parent) {
        ...
        setTitle("Polyglot - Learning Square");
        ...
        btnAddNote.addActionListener((e) -> {   // 노트버튼 추가 ActionListener***
            ...
            } else if (noteName.length() > 100) {   // 노트 글자수 100글자 초과시 경고문 주고 나옴
                JOptionPane.showMessageDialog(LearningSquareFrame.this, "노트 이름은 100글자를 초과할 수 없습니다.", "노트 추가 불가", 
                        JOptionPane.WARNING_MESSAGE);
                
                return;
            }
            
            // 해당 유저의 해당 언어에 같은 이름의 노트가 있을 시 경고문
        ...
        btnLearning.addActionListener((e) -> {
            ...
            ExerciseFrame.showExerciseFrame(LearningSquareFrame.this, note);
        });
        ...
        btnSignOut.setBounds(12, 58, 87, 23);
        contentPane.add(btnSignOut);
        
        btnMyInfo = new JButton("내 정보");
        btnMyInfo.addActionListener((e) -> {
        	accountSignedIn = dao.findAccountWithId(accountSignedIn.getAccount());
            MyInfoFrame.showMyInfoFrame(LearningSquareFrame.this, accountSignedIn);
        });
        // 내정보 보기 frame가서 내 정보 보여주고 수정 가능하게 하기
        btnMyInfo.setFont(new Font("D2Coding", Font.PLAIN, 9));
        btnMyInfo.setBounds(111, 58, 78, 23);
