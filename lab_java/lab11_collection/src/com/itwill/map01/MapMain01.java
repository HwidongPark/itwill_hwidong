...
public class MapMain01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(map.getOrDefault(10, "No value was found."));    // key가 있는 경우 -> value를 찾아서 return.
        System.out.println(map.getOrDefault(100, "No value was found"));    // key가 없는 경우 -> argument로 전달한 default value을 return
        ...
        // 2) key가 map에 있는 경우, key에 mapping되어 있는 값(value)를 변경.
        map.put(10, "허균");
        System.out.println(map);
