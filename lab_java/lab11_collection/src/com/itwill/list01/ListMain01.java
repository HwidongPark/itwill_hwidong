 ...
 * 2. 값들을 저장할 때 마다 인덱스는 자동으로 증가 - 저장공간이 자동으로 증가.
 * 3. 리스트 중간에 있는 값을 삭제하면 인덱스가 자동으로 재배열됨.
 * 4. 같은 값들을 여러번 저장할 수 있음 - Set<E>과 다른점.
...
public class ListMain01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(languages);
        List<String> list2 = Arrays.asList("Java", "SQL");
        List<String> list = new ArrayList<>(List.of("Java", "SQL", "Java", "HTML"));
        System.out.println(list);
        boolean result = list.remove("Java");
        System.out.println(list);
        boolean result2 = list.remove("Gidong");
