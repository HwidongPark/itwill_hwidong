...
public class ContactMain04 {
    ...
    private int selectMenu() {
        try {
            ...
            System.out.println("\n---------------------------------------------------------------");
            System.out.println("[0]종료 | [1]목록 | [2]새 연락처 | [3]인덱스 검색 | [4]업데이트 | [5]연락처 삭제");
            System.out.println("---------------------------------------------------------------");
            System.out.print("선택> ");
    ...
    private void deleteContact () {
        System.out.print("삭제할 연락처의 인덱스를 입력해 주세요. >>> ");
        int indexToDelete = getIntInput();
        if (dao.isValidIndex(indexToDelete)) {
            System.out.println("해당 인덱스의 연락처: " + dao.read(indexToDelete));
        } else {
        ...
        System.out.print("연락처 삭제를 진행하고 싶으면 [1]번을 눌러주세요. 취소하고 싶으면 아무 숫자나 입력하십시요. >>> ");
        int wantToProceed = getIntInput();
        if (wantToProceed == 1) {
            dao.delete(indexToDelete);
            System.out.println("해당 연락처를 삭제하였습니다.");
        } else {
            System.out.println("메인화면으로돌아갑니다.");
        }
