...
public class OperatorMain {
    ...
    public static void main(String[] args) {
        ...
        // 2. 단독으로 사용되는 경우는, 변수 앞에 있는 것과 변수 뒤에 있는 것이 동일.
        // 3. 다른 연산자와 함게 사용되는 경우에는, 
        //      (1) 변수 앞에 있는 경우는, 다른 연산자들보다 먼저 연산이 수행됨.
        ...
        //  (1) 덧셈(+): 1 + 10 = 11
        //  (2) 증가(++): n = 2
        // 2) 1)의 결과 + ++n --> 이거는 11 + ++n과 같다.
        //  (1) 증가(++): n = 3
        //  (2) 덧셈(+): 11 + 3 = 14  -> 최종 결과 -> result에 저장되는 값
