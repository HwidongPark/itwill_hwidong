...
<html>
	...
	<body>
		<h1>EL(Expression Language): (표헌)식 언어</h1>
        <%-- 
         ...
         <%-- 
            정보 저장 JSP 내장 객체:
              o. pageContext: JSP 페이지가 유지되는 동안에만 정보 저장.
         ...
         request.setAttribute("var", "helo");    // request에 정보 저장.
         ...
         o. pageScope   -   JSP의 pageContext에 해당
         o. requestScope    -   JSP의 request에 해당
         o. sessionScope    -   JSP의 session
         o. applicationScope    -   JSP의 application    
         ...
         var = ${ var }
         <%-- 
         EL에서 변수를 찾는 순서: ${var} 라고 했을 때
               (1) ${ pageScope.var }
               (2) ${ requestScope.var }
               (3) ${ sessionScope.var }
               (4) ${ application.var }
               여기까지도 못 찾았으면 그 값은 null됨
          --%>
         </p>
