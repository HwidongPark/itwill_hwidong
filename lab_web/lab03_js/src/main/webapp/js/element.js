...
// 브라우저가 HTML문서의 모든 요소들을 생성하고 난 후, 이벤트 리스너 콜백을 실행
document.addEventListener("DOMContentLoaded", function() {
    ...
    btn2.addEventListener("click", function() {
        ...
        // class이름으로 찾으면 배열처럼 들어감.. element가 1개일 때도 마찬가지인듯.
        for (let el of divs) {
            // console.log(el);
    ...
    // button#btn4 요소에 클릭 이벤트 리스터를 등록
    // id='d4' 요소의 바탕색 변경
    ...
    btn5.addEventListener('click', function() {
        const divs = document.querySelectorAll("div.c2"); // .c2라 해도됨
        for (let el of divs) {
