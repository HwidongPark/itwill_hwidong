...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // TODO: 모달의 [저장 내용 변경] 버튼(#btnUpdateComment)을 찾고, 클릭 이벤트 리스너 등록
     ...
     * async function: 비동기식(asynchronous)으로 동작하는 함수를 await 키워드로 호출하는 함수.
     */
    ...
    function updateComment() {
        // 삭제할 댓글 아이디를 찾음.
        console.log(id);
        // - Ajax PUT요청 보내서 댓글 업데이트
        const uri = `../api/comment/${id}`;
        // TODO: 데이터 작성법
        const data = {
            id: id,
            ctext: document.querySelector('#modalCommentText').value
        }
