...
public class UserDao {
    ...
    // 사용자가 포스트를 작성했을 때 x포인트를 지급:
    private static final String SQL_UPDATE_POINT = "UPDATE users SET points = points + ? WHERE userid = ?";
    
    public int updatePoints(int point, String userid) {
        log.debug("point to update = {}, userid to update={}", point, userid);
