...
// DTO(Data Transfer Object): 메서드의 아규먼트로 전달되거나 리턴 타입으로 사용되는 객체.
// 웹 계층 간(Controller <--> Service, Service <--> Repository)에 데이터를 주고 받을 때 사용되는 객체.
// 새 포스트 작성에서 사용될 DTO.
...
public class PostCreateDto {
    ...
    // PostCreateDto 타입의 객체를 Post타입의 객체로 변환해서 리턴하는 메서드
