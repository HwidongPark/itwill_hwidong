...
<html>
	...
	<body>
		<header class="my-2 p-4 bg-dark text-center text-white">
            <h1>회원가입 페이지</h1>
        </header>
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        <div class="my-2">
                         ...
                         <div class="my-2">
                            <input class="form-control"
                                type="password" name="password" placeholder="비밀번호" requried />                                
                         </div>
                         <div class="my-2">
                            <input class="form-control"
                         ...
                         <div class="my-2">
                            <input class="form-control btn btn-success" type="submit" value="회원가입" />
                         </div>
